...
<h1 class="alert alert-success" style="color: green"> DETAIL PRODUCT </h1>

<!-- <form action="" method="post" id="form" enctype="multipart/form-data" class="row mt-3">
...
<!--     
    ...
    <div class="col-md-4 mb-3">
        ...
        <input class="form-control" type="text"   name="quanity"  value="<?=$quanity?>">
    </div>
